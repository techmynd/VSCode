{
  ...
  "CSS New Document": {
    ...
    "body": [
      ...
      "button, .btn {font-family: $font-heading;}",
      "",
      ".pg-wrapper {height: 100%;}",
      "a, a:hover, img, img:hover, button, button:hover, i, i:hover {transition: all 0.3s ease-in-out;}",
      ...
      "button:focus, .btn:focus, a:focus, input:focus, .form-control:focus {outline: 0;}",
      "button, .btn {background-image: none; text-shadow: none; box-shadow: none;}",
      "",
    ...
    "description": "CSS New Document"
  },
  "snip custom js": {
    "prefix": "snip-customjs",
    "body": [
  ...
  "snip section": {
    ...
    "description": "snip section"
  },
  "snip flex html": {
    "prefix": "snip-flexhtml",
    "body": [
      "<div class=\"flex-row\">",
      "  <div class=\"flex-col\">",
      "    ...",
